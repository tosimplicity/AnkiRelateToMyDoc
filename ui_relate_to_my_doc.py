...
class Ui_relate_to_my_doc_dialog(object):
    def setupUi(self, relate_to_my_doc_dialog):
        ...
        doc_title_layout = QtWidgets.QHBoxLayout()
        doc_title_mark_label = QtWidgets.QLabel('Title:')
        doc_title_layout.addWidget(doc_title_mark_label)
        self.doc_title_label = QtWidgets.QLabel('')
        self.doc_title_label.setTextInteractionFlags(
            QtCore.Qt.TextSelectableByMouse)
        self.doc_title_label.setAlignment(QtCore.Qt.AlignLeft)
        # self.doc_title_label.setWordWrap(True)
        doc_title_layout.addWidget(self.doc_title_label)
        doc_title_layout.addStretch()
        self.verticalLayout_text.addLayout(doc_title_layout)
        ...
        self.media_tab_vlayout = QtWidgets.QVBoxLayout(self.media_tab)
        self.media_tab_vlayout.setContentsMargins(12, 12, 12, 12)
        self.media_tab_vlayout.setSpacing(12)
        self.media_tab_vlayout.setObjectName("media_tab_vlayout")
        ...
        self.media_tab_vlayout.addLayout(self.horizontalLayout_3)
        ...
        self.media_tab_vlayout.addWidget(self.mplayer_widget_container)
        ...
        self.media_tab_vlayout.addWidget(self.media_text_listWidget)
        ...
        self.toggle_media_button = QtWidgets.QPushButton(self.media_tab)
        self.toggle_media_button.setObjectName("toggle_media_button")
        self.horizontalLayout_4.addWidget(self.toggle_media_button)
        ...
        self.ffmpeg_cut_script_button = QtWidgets.QPushButton('Cut Script', self.media_tab)
        self.horizontalLayout_4.addWidget(self.ffmpeg_cut_script_button)
        ...
        self.media_tab_vlayout.addLayout(self.horizontalLayout_4)
        # don't add to the layout
        self.ffmpeg_cut_script_label = QtWidgets.QLabel()
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ffmpeg_cut_script_label.sizePolicy().hasHeightForWidth())
        self.ffmpeg_cut_script_label.setSizePolicy(sizePolicy)
        self.ffmpeg_cut_script_label.setObjectName("ffmpeg_cut_script_label")
        # selectable text which can be copied
        self.ffmpeg_cut_script_label.setTextInteractionFlags(QtCore.Qt.TextSelectableByMouse)
        self.ffmpeg_cut_script_label.setAlignment(QtCore.Qt.AlignLeft)
        self.ffmpeg_cut_script_label.setWordWrap(True)
    ...
    def retranslateUi(self, relate_to_my_doc_dialog):
        ...
        self.toggle_media_button.setText(_translate("relate_to_my_doc_dialog", "Play/Stop"))
